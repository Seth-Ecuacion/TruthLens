  ...
  return (
    <div className="min-h-screen flex flex-col relative bg-slate-50">
      ...
      <footer className="bg-[#0D1B2A] text-white pt-20 pb-16 mt-20 border-t border-white/5 relative overflow-hidden">
        ...
        >
          {/* FIXED: Using local image to prevent broken hotlinks */}
          <img 
            src="/cyber-lens.jpg" 
            alt="Cyber Lens" 
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
          <div className="md:col-span-2">
            ...
            {/* FIXED: Accurate academic disclaimer */}
            <p className="text-slate-500 text-xs max-w-sm leading-relaxed mb-6 italic">
              Powered by a triangulated RAG architecture utilizing IFCN-certified fact-checkers, university-backed consortiums, and mainstream broadcast networks.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {navLinks.slice(1).map(link => (
                <li key={link.path}>
                  <Link href={link.path} className="text-slate-400 hover:text-[#00C2CB] text-sm transition-colors flex items-center gap-2">
                    {link.path === '/ethics' && <span className="w-1.5 h-1.5 rounded-full bg-[#00C2CB]"></span>}
                    {link.path === '/ethics' ? 'ACM Ethics Framework' : link.label}
                  </Link>
                </li>
              ))}
            </ul>
          ...
          <div>
            <h4 className="text-white font-semibold mb-6">Triangulated Sources</h4>
            <ul className="space-y-4">
              <li><a href="https://tsek.ph/" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-[#00C2CB] text-sm transition-colors">UP Tsek.ph Consortium</a></li>
              ...
              <li><a href="https://www.gmanetwork.com/news/" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-[#00C2CB] text-sm transition-colors">GMA Integrated News</a></li>
